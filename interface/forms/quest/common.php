...
$query .= "WHERE ls.`list_id` LIKE 'Quest_Laboratory%' AND ls.`activity` = 1 ";
...
<?php } ?>
				...
				newRow += "<td style='vertical-align:top;min-width:130px'><input type='button' class='wmtButton' value='remove' style='width:60px' onclick=\"removeTestRow('test_"+id+"')\" /> ";
...
foreach ($item_list as $order_item) { // $item = array of objects
	...
	$newRow .= "<td style='vertical-align:top;min-width:130px'>\n";
...
?>
								...
								<tr>
									<td class="wmtLabel" nowrap style="text-align: right">Billing
										Method:</td>
...
<?php } ?>
				<tr>
				<td class="wmtLabel"
					style="vertical-align: top; float: left; width: 90px"><a
					class="css_button" tabindex="-1" href="javascript:saveClicked()"><span>Save	Work</span></a></td>
<?php if ($status == 'i') { ?>	
