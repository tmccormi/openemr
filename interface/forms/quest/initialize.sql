...
CALL lab_table_update(@db,"procedure_order","specimen_draw","VARCHAR(31) DEFAULT NULL");
...
('Lab_Draw', 			'iop', 			'Lab IOP', 					1, 0, 0, '', '', ''),
('Lab_Draw', 			'int', 			'Clinic Draw', 				2, 0, 0, '', '', ''),
...
('lists', 	'Quest_Draw',			 	'Quest Draw', 				0, 1, 0, '', ''),
...
('Quest_States', 			'A', 			'Ambient', 				10, 0, 0, '', ''),
('Quest_States', 			'F', 			'Frozen', 				20, 0, 0, '', ''),
('Quest_States', 			'FR/FZ', 		'Frozen', 				30, 0, 0, '', ''),
('Quest_States', 			'G', 			'Refrigerated', 		40, 0, 0, '', ''),
('Quest_States', 			'H', 			'Handwritten', 			50, 0, 0, '', ''),
('Quest_States', 			'M', 			'Multiple Types', 		60, 0, 0, '', ''),
('Quest_States', 			'R', 			'Room Temperature', 	70, 0, 0, '', ''),
('Quest_States', 			'RT', 			'Room Temperature', 	120, 0, 0, '', ''),
('Quest_States', 			'S', 			'Split Requisition', 	80, 0, 0, '', ''),
('Quest_States', 			'T', 			'DISCONTINUED', 		90, 0, 0, '', ''),
('Quest_States', 			'W', 			'Wet Ice', 				100, 0, 0, '', ''),
('Quest_States', 			'Z', 			'Pain Management', 		110, 0, 0, '', '');
