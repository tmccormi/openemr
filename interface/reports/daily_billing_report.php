<?php
// Copyright (C) OEMR.ORG - developed by Ramkrishna.Mehendale@whcchicago.com
...
?>
 ...
 <tr bgcolor="#ffdddd">
  ...
  <td class="detail" colspan="3">
   <?php echo xl('Total for patient: ') . ' '; echo display_desc($category); ?>
  </td>
  <td align="right">
   <?php echo $catqty; ?>
  </td>
...
<title><?php xl('Daily Billing Report','e') ?></title>
</head>

<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0' class="body_top">

<span class='title'><?php xl('Report','e'); ?> - <?php xl('Daily Billing Report','e'); ?></span>

<form method='post' action='DailyBillingReport.php' id='theform'>
...
<?php
  ...
  if ($_POST['form_refresh'] || $_POST['form_csvexport']) {
    ...
    if ($INTEGRATED_AR) {
    $query = "SELECT b.fee, b.pid, b.provider_id, b.encounter, b.code_type, b.code, b.units, " .
      ...
      // because bill_date chages with re-opens and mark-cleared
    ...
    $query .= " ORDER BY p.lname, fe.date, b.pid, lo.title, b.code, fe.id";  
    //
