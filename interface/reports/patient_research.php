<?php
    ...
    //
    // Used to reseach patient information of many type and link directly to the patient records from
    // the onscreen results, include export to CSV format as well.
    //
	//@TODO htmlspecialchars on $POST data
    //@TODO clean up stuff that is not useful and was left by InteSync programmer
			...
			<table>
				...
				<?php
					...
					<tr>
						...
						?>
						<td> <a target="RBot" onClick="top.window.parent.left_nav.active_pid =<?php echo htmlspecialchars($row['pid'], ENT_QUOTES); ?>" href="../patient_file/summary/demographics.php?set_pid=<?php echo htmlspecialchars($row['pid'], ENT_QUOTES); ?>"><?php echo htmlspecialchars($row['patient_name'], ENT_QUOTES); ?></a>&nbsp;</td>
