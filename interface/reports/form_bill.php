...
require_once("$srcdir/wmt/formhunt.inc");
...
$bill_forms = getFormsByType('bill_form');
...
if ($res) {
  ...
  while ($row = sqlFetchArray($res)) {
    ...
    $sql = "SELECT form_priority, form_complete FROM $this_form WHERE $this_form.id='$this_id'";
