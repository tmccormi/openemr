...
<?php if (acl_check('acct', 'rep_a')) { ?>
      <li><a class="collapsed_lv2"><span><?php xl('Financial','e') ?></span></a>
        <ul>
         ...
         <?php genNewTab(xl('Availity Billing'),'../reports/availity_billing_report.php'); ?>
         ...
         <?php genNewTab(xl('Provider Income'),'../reports/providerincome_report.php'); ?>
          ...
          <?php genMiscLink('RTop','rep','0',xl('Availity Billing'),'reports/availity_billing_report.php'); ?>
