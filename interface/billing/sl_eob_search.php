...
if ($INTEGRATED_AR) {
  ...
  //Changed Payer_id for patient to '1' from '0' so that new session id was not generated by arGetsessionId for the same check number and check date
  //echo "    <option value='0'>-- " . xl('Patient') . " --</option>\n";
  echo "    <option value='1'>-- " . xl('Patient') . " --</option>\n";
...
?>
  ...
  <td>
  <?php xl('Chk/Warr #','e');    //Changed 'Source:' to 'Chk/Warr#' ?>
  </td>
  <td>
  ...
  <td>
  <?php xl('Chk Date:','e'); //Changed 'Pay Date:' to 'Chk Date:' ?>
  </td>
  <td>
...
<?php } ?>
  ...
  <td>
  <?php xl('Chk Amt:','e'); //Changed 'Amount:' to 'Chk Amt:' ?>
  </td>
  <td>
