...
<input id="name" type="hidden" size="40" name="name" value="pseudo_name" maxlength="{$settings.username_maxlength}"  tabindex="1" />

{*<label for="email" class="input">{#email_marking#}</label>*}
<input id="email" type="hidden" size="40" name="email" value="" maxlength="{$settings.email_maxlength}" tabindex="2" />

{*<label for="hp" class="input">{#hp_marking#}</label>*}
<input id="hp" type="hidden" size="40" name="hp" value="" maxlength="{$settings.hp_maxlength}" tabindex="3" />

{*<label for="location" class="input">{#location_marking#}</label>*}
<input id="location" type="hidden" size="40" name="location" value="" maxlength="{$settings.location_maxlength}" tabindex="4" />
...
<textarea id="text" cols="40" rows="5" name="text" tabindex="7">{if $text}{$text}{/if}</textarea>
