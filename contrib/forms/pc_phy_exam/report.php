...
function pc_phy_exam_report( $pid, $encounter, $cols, $id) {
  $count = 0;
  $data = formFetch("form_pc_phy_exam", $id);
...
if ( ($data["col_62"] != "N/A" && $data["col_62"] != "" && $data["col_62"] != "--") || ( $data["col_62_textbox"] != "" && $data["col_62_textbox"] != null ) ) {
  ...
  if ( ($data['other_notes'] != null)) {
      echo "<tr>";
        echo "<td colspan='3'><span class='bold'><u>OTHER NOTES</u></span></td>";
        echo "<td><span class='text'>(${data['other_notes']})</span></td>";
      echo "</tr>";
  }
