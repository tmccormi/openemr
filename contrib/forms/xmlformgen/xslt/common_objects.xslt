...
<xsl:for-each select="//manual//field[@type='checkbox_list' or @type='exams' or @type='checkbox_combo_list' or @type='textbox' or @type='textarea' or @type='provider' or @type='date' or @type='textfield' or @type='dropdown_list']">
<xsl:text disable-output-escaping="yes"><![CDATA[ ']]></xsl:text>
<xsl:value-of select="@name" />
<xsl:text disable-output-escaping="yes"><![CDATA[' => 
