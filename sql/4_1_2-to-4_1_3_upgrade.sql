...
#IfNotColumnType prescriptions date_modified datetime
	ALTER TABLE  `prescriptions` CHANGE  `date_modified`  `date_modified` DATETIME NULL DEFAULT NULL;
#EndIf

#IfNotColumnType prescriptions date_added datetime
	ALTER TABLE  `prescriptions` CHANGE  `date_added`  `date_added` DATETIME NULL DEFAULT NULL;
#EndIf